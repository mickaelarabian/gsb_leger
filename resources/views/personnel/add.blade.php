...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Ajouter un personnel | GSB</title>
                                                                      ...
                                                                      <form action="/personnels/create" method="post">
                                                                          @csrf
                                                                              ...
                                                                              <div class="form-group">
                                                                                      ...
                                                                                      <input type="text" class="form-control" name="email" aria-describedby="emailHelp" placeholder="mickaelarabian@gmail.com" required>
                                                                                  </div>
                                                                                  <div class="form-group">
