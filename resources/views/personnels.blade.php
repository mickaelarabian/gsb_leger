    ...
    <div class="row">
        ...
        <div class="col-10" style="position: absolute; right:0;">
            ...
            <div data-toggle="modal" data-target="#exampleModal" style="position:absolute; top:15px; right: 40px;">
                <a class="shadow-sm" style="font-size: 13px; padding: 5px 10px; color: #fff; background-color: #6b5aed; border-radius: 4px;" class="row" href="/personnels/create"><i style="width:17px; height:17px;" data-feather="plus"></i> Nouveau personnel</a>
            </div>
                            ...
                            <div class="body p-0">
                                <div class="">
                                    <div class="p-2 mb-2 shadow-sm rounded row" style="background-color:#fff; color:#424242;">
                                        ...
                                        <div class="col-2 text-center">
                                            <h6 class="card-title mb-0" style="font-weight:bold;font-size: 13px">Mail</h6>
                                        </div>
                                    ...
                                    <div class="bg-white p-2 mb-2 shadow-sm rounded row">
                                        ...
                                        <div class="col-2 p-1 text-center" style="font-size: 13px">
                                            <p class="card-title mb-0">{{$personnel->email}}</p>
                                        </div>
                                        ...
                                        <div class="dropdown" style="position: absolute; right:0;">
                                            ...
                                            <div class="dropdown-menu" style="background: none; border:none" aria-labelledby="dropdownMenu2">
                                                <div class="w-25">
                                                    <div class="shadow-sm" style="width: 23px;border-radius: 20px; padding: 4px 6px; font-size: 10px; background-color:#00b9af;"><a href="/personnels/update/{{$personnel->id}}"><i style="width:12px; height:12px; color: #fff" data-feather="edit-2"></i></a> </div>
                                                    <div class="shadow-sm" style="width:23px;margin-top:5px;border-radius: 20px; padding: 4px 5.5px; font-size: 10px; background-color:#00b9af;"><a href="/personnels/delete/{{$personnel->id}}"><i style="width:12px; height:12px; color: #fff" data-feather="trash"></i></a></div>
                                                </div>
                                            </div>
                                        </div>
