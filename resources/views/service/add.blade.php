...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Ajouter un service | GSB</title>
                ...
                <div class="row">
                        ...
                        <div class="col-10" style="position: absolute; right:0;">
                            <nav aria-label="breadcrumb" style="width: 40%; margin-top: 25px">
                              ...
                              <a class="shadow-sm" style="font-size: 15px; padding: 5px 15px; color: #fff; background-color: #6b5aed; border-radius: 25px; font-size:13px;" class="row" href="/services/siege/{{$id}}"><i style="font-size: 14px; padding-top:5px;" class="fas fa-undo"></i> Retourner à la liste</a>
                            </div>
