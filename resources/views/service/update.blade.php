...
<head>
    ...
    <title>Modifier un service | GSB</title>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="border:none; background:none;">
                                        ...
                                        <div class="modal-body rounded bg-white shadow-sm">
                                            <form action="/services/update/{{$id}}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Nom</label>
                                                    <input type="text" class="form-control" value="{{$service->nom}}" name="nom" aria-describedby="emailHelp" placeholder="Recherche et développement" required>
                                                </div>
                                                <div class="form-group">
