...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Les services du siège {{$siege->nom}} | GSB</title>
                ...
                <div class="row">
                        ...
                        <div class="col-10" style="position: absolute; right:0;">
                            <nav aria-label="breadcrumb" style="width: 40%; margin-top: 25px">
                              ...
                              <a class="shadow-sm" style="font-size: 13px; padding: 5px 10px; color: #fff; background-color: #6b5aed; border-radius: 4px;" class="row" href="/services/create/{{$siege->id}}"><i style="width:17px; height:17px;" data-feather="plus"></i> Nouveau service</a>
                            </div>
                            <div class="mt-4 mb-4">
                            <h4 style="font-weight:500; text-align: center">Les services du siège {{$siege->nom}}</h4>
                            </div>
                            ...
                            <div class="col-4">
                                    <div class="card shadow-sm mb-5 bg-white rounded border-0">
                                        <div class="card-body p-0">
                                            ...
                                            <p class="card-text" style="font-size:13px">Budget restant: <i style="color:#54d575;">{{number_format($service->budget)}} €</i></p>
                                        </div>
