...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Liste des sièges | GSB</title>
                        ...
                        <div class="col-10" style="position: absolute; right:0;">
                            <nav aria-label="breadcrumb" style="width: 40%; margin-top: 25px">
                                ...
                                <div data-toggle="modal" data-target="#exampleModal" style="position:absolute; top:15px; right: 40px;">
                                        <a class="shadow-sm" style="font-size: 13px; padding: 5px 10px; color: #fff; background-color: #6b5aed; border-radius: 4px;" class="row" href="/sieges/create"><i style="width:17px; height:17px;" data-feather="plus"></i> Nouveau siège</a>
                                    </div>
                                    <div class="mt-4 mb-4">
                                        ...
                                        <div class="p-3">
                                            <div class="dropdown" style="position: absolute; top:0; right:0;">
                                                    ...
                                                    <div class="dropdown-menu" style="background: none; border:none" aria-labelledby="dropdownMenu2">
                                                            <div class="w-25">
                                                            <div class="shadow-sm" style="width: 23px;border-radius: 20px; padding: 4px 6px; font-size: 10px; background-color:#00b9af;"><a href="/sieges/update/{{$siege->id}}"><i style="width:12px; height:12px; color: #fff" data-feather="edit-2"></i></a> </div> <div class="shadow-sm" style="width:25px;margin-top:5px;border-radius: 20px; padding: 5px 8px; font-size: 10px; background-color:#00b9af;"><a href="/sieges/delete/{{$siege->id}}"><i style="color: #fff" class="fas fa-trash-alt"></i></a></div>
                                                            </div>
                                                     </div>
                                                  </div>
