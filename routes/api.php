...
Route::group(['prefix' => 'sieges'], function(){
    ...
    Route::get('/count', 'SiegeController@getCount');
    Route::post('/update', 'SiegeController@updateSiege');
    Route::get('/delete/{id}', 'SiegeController@deleteSiege');
    Route::post('/create', 'SiegeController@createSiege');
  });
